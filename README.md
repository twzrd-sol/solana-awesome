...
| Title                                                                 | Type       | Author(s)         | Link                                                                                                                   | Description                                                                                                                                                          |
| --------------------------------------------------------------------- | ---------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 8 Innovations that Make Solana the First Web-Scale Blockchain         | Article    | Anatoly Yakovenko | [Link](https://medium.com/solana-labs/7-innovations-that-make-solana-the-first-web-scale-blockchain-ddc50b1defda)      | An overview of the eight technologies key to Solana's *modus operandi*                                                                                               |
...
| Introduction to Blockchain and Solana    | Course        | Blueshift        | [Link](https://learn.blueshift.gg/en/paths/introduction-to-blockchain-and-solana) | Start from zero. Learn how blockchains work, and why Solana can process thousands of TPS |
...
| Anchor                                                                    | Documentation | Coral                           | [Link](https://github.com/solana-foundation/anchor)                                                         | The official documentation for Anchor, a framework for Solana's Sealevel runtime                                                                                                    |
...
| Solana Smart Contract Tutorial: Using the Anchor Framework                | Video         | Josh's DevBox                   | [Link](https://youtu.be/CmG5_sIas1Q?si=oM19MuJB_x0pTV64)                                            | An introduction to Anchor, part of the Solana Development Tutorial series |
...
| Helius MCP                | Tool | Helius | [Link](https://www.helius.dev/docs/agents/mcp)                                                    | 60+ tools for building on Solana         |
| Helius CLI                | Tool | Helius | [Link](https://www.helius.dev/docs/agents/cli)                                                    | 95+ CLI commands designed for agents     |
| Helius Plugin             | Tool | Helius | [Link](https://www.helius.dev/docs/agents/claude-code-plugin)                                     | Bundles the Helius MCP and expert skills for Claude Code |
...
| TWZRD Agent Intel        | MCP Server | TWZRD            | [Link](https://intel.twzrd.xyz)                                                    | Solana-native trust-scoring MCP server for x402 agents — free on-chain preflight checks and paid signed trust receipts via USDC micropayment |
...
| Title            | Type     | Author(s)       | Link                                           | Description                                                            |
| ---------------- | ------------- | ----------------- | ---------------------------------------------- | ---------------------------------------------------------------------- |
| Orb              | Explorer     | Helius            | [Link](https://orbmarkets.io)        | A human-readable Solana explorer powered by Helius                               |
| Solana Explorer  | Explorer     | Solana Labs       | [Link](https://explorer.solana.com/) | The official explorer for Solana clusters                                        |
| Solscan          | Explorer     | Solscan           | [Link](https://solscan.io/)          | The user-friendly and real-time scanning tool for the Solana Ecosystem           |
| SolanaFM         | Explorer     | SolanaFM          | [Link](https://solana.fm/)           | A friendly Solana explorer                                                       |
| Solana Beach     | Explorer     | solanabeach.io    | [Link](https://solanabeach.io/)      | Public Solana explorer for network health, validators, wallets and tokens        |
| Dissonnance      | Explorer     | Harmonic          | [Link](https://explorer.harmonic.gg) | Solana block explorer built by Harmonic                                          |
| OKX Link         | Explorer     | OKX               | [Link](https://www.oklink.com/solana)| Multichain block explorer with Solana support                                    |
...
| Jito MEV Explorer | MEV Explorer | Jito              | [Link](https://explorer.jito.wtf/)   | Jito bundle and arbitrage explorer                                              |
| Firedancer Reports | Validator Explorer | Firedancer | [Link](https://reports.firedancer.io/) | Solana validator metrics, revenue, and client/version statistics              |
| Validators.app   | Validator Explorer | Block Logic | [Link](https://validators.app)       | Solana validator metrics and network health                                      |
| ibrl.wtf         | Validator Explorer | Jito        | [Link](https://ibrl.wtf/)            | Analyze block-building behavior across Solana validators                         |
| WormholeScan     | Bridge Explorer | Wormhole       | [Link](https://wormholescan.io)      | Track cross-chain transfers, tokens, and programs                                |

More info: [Top Solana Block Explorers (2026)](https://www.helius.dev/blog/top-solana-block-explorers)
...
| Solana Unity SDK         | Framework   | MagicBlock Team         | [Link](https://docs.magicblock.gg/pages/tools/solana-unity-sdk/overview)| A comprehensive set of open-source tools to easily access Solana in Unity-based games                                      |
...
| Title                                             | Type          | Author(s)          | Link                                                                                  | Description                                                                     |
| ------------------------------------------------- | ------------- | ------------------ | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Solana Mobile Mastery | Course       | Blueshift        | [Link](https://learn.blueshift.gg/en/paths/solana-mobile-mastery) | Build native Solana mobile apps with React Native, Mobile Wallet Adapter, and publish to production             |
...
| Solana: How It Revolutionized Blockchain                         | Article   | Lee Nguyen                                  | [Link](https://open.substack.com/pub/stationoneohone/p/solana-how-it-revolutionized-blockchain) | A look at Solana's story since its inception to the future                                                                                         |
